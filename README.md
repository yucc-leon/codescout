This fork contains an experimental Ascend NPU adaptation of CodeScout. See [Ascend NPU Training Guide / 昇腾 NPU 训练指南](docs/npu-training-guide.md) below.

本 fork 包含 CodeScout 的昇腾 NPU 适配。详见 [昇腾 NPU 训练指南](docs/npu-training-guide.md)。
